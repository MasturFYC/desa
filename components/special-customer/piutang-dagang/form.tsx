    ...
    <View paddingX={{ base: "size-50", M: "size-100" }}>
              ...
              <SpecialPaymentForm
                ...
                updatePayment={(method, data) => {
                  updateOrder(order.id === 0 ? "POST" : "PUT", {
                    ...order,
                    remainPayment: order.remainPayment - data.nominal,
      ...
      <Form onSubmit={handleSubmit}>
        ...
        >
          ...
          <View flex>
            ...
            <TextArea
              ...
              placeholder={
                "e.g. Jl. Jend. Sudirman No. 155 Tanjung Priuk\nJakarta Timur"
              }
        ...
        <TextArea
          ...
          flex
          placeholder={
            "e.g. Pembayaran paling lambar sampai dengan tanggal ..."
          }
          label={"Keterangan"}
